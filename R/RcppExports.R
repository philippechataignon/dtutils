...
Ccummax_by <- function(x, rows) {
    .Call('_dtutils_Ccummax_by', PACKAGE = 'dtutils', x, rows)
}

Ccummin_by <- function(x, rows) {
    .Call('_dtutils_Ccummin_by', PACKAGE = 'dtutils', x, rows)
}

Ccumsurv_by <- function(x, rows) {
